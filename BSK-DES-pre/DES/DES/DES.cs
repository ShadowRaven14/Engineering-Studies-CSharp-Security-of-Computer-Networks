...
namespace DES
{
    ...
    public static class DESunio
    {
        ...
        private static List<int[]> GeneratePermutatedKeys(int[] binaryKey)
        {
            ...
            SplitArray(key56B, out int[] C, out int[] D);

            List<int[]> joinedPermutatedKeys = new List<int[]>(); //Lista połączonych 'C' i 'D' po permutacji ('Kn')
